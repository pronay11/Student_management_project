...
from student_management_system_app.models import Courses, SessionYearModel
...
class AddStudentForm(forms.Form):
    ...
    username = forms.CharField(label="Username", max_length=55, widget=forms.TextInput(attrs={"class":"form-control"}))
    ...
    session_year_id = forms.ChoiceField(label="SessionYear",widget=forms.Select(attrs={"class":"form-control"}),choices=session_list)
    profile_pic = forms.FileField(label="Profile Pic", max_length=55, widget=forms.FileInput(attrs={"class":"form-control"}))
...
class EditStudentForm(forms.Form):
    ...
    sex = forms.ChoiceField(label="Sex", choices=gender_choice, widget=forms.Select(attrs={"class":"form-control"}))
    session_year_id = forms.ChoiceField(label="SessionYear", widget=forms.Select(attrs={"class": "form-control"}),choices=session_list)
    profile_pic = forms.FileField(label="Profile Pic", max_length=55, widget=forms.FileInput(attrs={"class":"form-control"}),required=False)
